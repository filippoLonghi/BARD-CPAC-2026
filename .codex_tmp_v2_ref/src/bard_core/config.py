...
class BardSettings:
    ...
    def from_env(cls) -> "BardSettings":
        ...
        image_model = os.environ.get("BARD_IMAGE_MODEL") or os.environ.get("BARD_IMAGEN_MODEL") or "gemini-2.5-flash-image"
        image_location = (
        ...
        return cls(
            ...
            gcp_location=env_str("BARD_GCP_LOCATION", os.environ.get("GOOGLE_CLOUD_LOCATION", "global")),
