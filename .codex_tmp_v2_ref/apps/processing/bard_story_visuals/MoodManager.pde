class MoodManager {
  ...
  void setupMoods() {
    ...
    // Keep these labels synchronized with src/bard_core/contracts.py::MOOD_LABELS.
    moods.put("ENERGETIC", new Atmosphere(color(180, 140, 40), color(255, 255, 240), color(255, 255, 180), color(255, 255, 255), -2.0f, 200.0f, 0.8f, color(250, 250, 150), 180.0f, 0.02f));
    moods.put("SOLO", new Atmosphere(color(190, 130, 150), color(60, 20, 40), color(230, 180, 200), color(255, 255, 255), 0f, 60.0f, 0.1f, color(160, 100, 120), 60.0f, 0.002f));
    ...
    moods.put("DEEP", new Atmosphere(color(11, 2, 17), color(170, 180, 200), color(50, 80, 150), color(30, 40, 80), 0.3f, 80.0f, 0.2f, color(20, 40, 80), 150.0f, 0.004f));
    moods.put("DISSONANT", new Atmosphere(color(45, 45, 65), color(210, 210, 220), color(100, 120, 180), color(80, 80, 100), 0.1f, 120.0f, 0.4f, color(70, 90, 130), 180.0f, 0.005f));
    ...
    moods.put("DARK", moods.get("DEEP"));
    moods.put("DENSE", moods.get("DISSONANT"));
    moods.put("RISING TENSION", moods.get("ANXIOUS"));
    moods.put("RISING_TENSION", moods.get("ANXIOUS"));
    moods.put("RELEASE", moods.get("CALM"));
    moods.put("BRIGHT", moods.get("ENERGETIC"));
    moods.put("SPARSE", moods.get("SOLO"));
  }
