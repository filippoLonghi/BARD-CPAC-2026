class MoodManager {
  ...
  */
    ...
    moods.put("ANXIOUS", new Atmosphere(color(85, 60, 150), color(255, 255, 200), color(200, 50, 255), color(150, 100, 255), 4.0f, 300.0f, 1.0f, color(180, 40, 180), 220.0f, 0.025f));
    ...
    moods.put("RISING TENSION", new Atmosphere(color(120, 60, 85), color(250, 200, 210), color(200, 50, 100), color(180, 80, 100), -3.0f, 250.0f, 3.0f, color(150, 40, 70), 200.0f, 0.03f));
    ...
    moods.put("BRIGHT", new Atmosphere(color(180, 140, 40), color(255, 255, 240), color(255, 255, 180), color(255, 255, 255), -2.0f, 200.0f, 1.0f, color(250, 250, 150), 180.0f, 0.02f));
