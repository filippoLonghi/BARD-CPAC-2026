class MoodManager {
  ...
  void setupMoods() {
    ...
    moods.put("DARK", new Atmosphere(color(11, 2, 17), color(170, 180, 200), color(50, 80, 150), color(30, 40, 80), 0.3f, 80.0f, 0.4f, color(20, 40, 80), 150.0f, 0.004f));
    moods.put("CALM", new Atmosphere(color(30, 20, 75), color(240, 240, 255), color(150, 100, 255), color(100, 80, 180), -0.3f, 60.0f, 0.2f, color(120, 80, 200), 150.0f, 0.008f));
    moods.put("ANXIOUS", new Atmosphere(color(85, 60, 150), color(255, 255, 200), color(200, 50, 255), color(150, 100, 255), 4.0f, 300.0f, 1.5f, color(180, 40, 180), 220.0f, 0.025f));
    moods.put("DENSE", new Atmosphere(color(45, 45, 65), color(210, 210, 220), color(100, 120, 180), color(80, 80, 100), 0.1f, 120.0f, 0.5f, color(70, 90, 130), 180.0f, 0.005f));
    moods.put("RISING TENSION", new Atmosphere(color(120, 60, 85), color(250, 200, 210), color(200, 50, 100), color(180, 80, 100), -3.0f, 250.0f, 5.0f, color(150, 40, 70), 200.0f, 0.03f));
    ...
    moods.put("BRIGHT", new Atmosphere(color(180, 140, 40), color(255, 255, 240), color(255, 255, 180), color(255, 255, 255), -2.0f, 200.0f, 1.5f, color(250, 250, 150), 180.0f, 0.02f));
    moods.put("SPARSE", new Atmosphere(color(190, 130, 150), color(60, 20, 40), color(230, 180, 200), color(255, 255, 255), 0f, 60.0f, 0f, color(160, 100, 120), 60.0f, 0.002f));
  }
